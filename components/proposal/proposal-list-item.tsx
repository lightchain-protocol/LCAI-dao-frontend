...
import { cn, compactNumber, isArchivedProposal } from "@/lib/utils";
...
interface ProposalListItemProps {
  ...
  /** true = voted, false = not voted, null = loading, undefined = hidden */
...
export function ProposalListItem({
  ...
  const isPriorityTierZeroRow = showVoteBadge && !walletHasVotedOnActive;
